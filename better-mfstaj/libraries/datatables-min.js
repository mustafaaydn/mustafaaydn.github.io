...
(function(h) {
	...
	n.defaults = {
		...
		oLanguage: {
			...
			sEmptyTable: "",
			sInfo: "&nbsp;&nbsp;<em>Showing _START_ to _END_ of _TOTAL_ entries",
			sInfoEmpty: "",
			sInfoFiltered: "",
			sInfoPostFix: "",
			sDecimal: "",
			...
			sSearchPlaceholder: "",
			sUrl: "",
			sZeroRecords: "No matching records found for the given criteria :/"
		},
		oSearch: h.extend({},
			n.models.oSearch),
		sAjaxDataProp: "data",
	...
	h.extend(x.type.order, {
		...
		"html-pre": function(a) {
			...
			return M(a) ?
				"" : a.replace ? a.replace(/<.*?>/g, "").toLocaleLowerCase() : a + ""
		},
		...
		/*"string-pre": function(a) {
			...
			return M(a) ? "" : "string" === typeof a ? a.toLocaleLowerCase() : !a.toString ? "" : a.toString()
		},*/
	});
	Da("");
	h.extend(!0, n.ext.renderer, {
